			...
			<div className='container mx-auto px-4 max-w-5xl'>
				...
				<div className='bg-white rounded-[30px] shadow-md p-8'>
					...
					<div className='space-y-4 text-lg text-[#2A3F54]'>
						...
						<p>
							<strong>2. Бірінші ішек (G3):</strong> Домбыраның жоғарғы ішегі
							сол малой октавасы (G3) нотасына күйленеді.
						</p>
						<p>
							<strong>3. Екінші ішек (D3):</strong> Домбыраның төменгі ішегі ре
							малой октавасы (D3) нотасына күйленеді.
						</p>
						<p>
