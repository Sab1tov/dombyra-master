						...
						<div className='flex items-center bg-white bg-opacity-20 border border-white border-opacity-50 rounded-full overflow-hidden'>
							<div className='relative w-full'>
								<input
									...
									className='w-full flex-grow bg-transparent text-black placeholder-white placeholder-opacity-50 px-4 py-3 sm:pl-6 sm:py-4 pr-16 sm:pr-20 focus:outline-none text-sm sm:text-base'
									value={searchQuery}
									onChange={e => setSearchQuery(e.target.value)}
								/>

								<button className='absolute right-6 sm:right-8 top-1/2 transform -translate-y-1/2'>
									<svg
										width='20'
										height='20'
										viewBox='0 0 24 24'
